      ...
      <SafeAreaProvider>
        ...
        <NavigationContainer>
          <Drawer.Navigator drawerContent={props => <DrawerContent {...props} />}>
            ...
            <Drawer.Screen name="Barcode" component={Barcode} options={{ headerStyle: { backgroundColor: '#fdca40', }, headerTintColor: 'black', }} />
            <Drawer.Screen name="Add Activity" component={AddActivity} options={{ headerStyle: { backgroundColor: '#fdca40', }, headerTintColor: 'black', }} />
            <Drawer.Screen name="Add Activity" component={AddActivity} options={{ headerStyle: { backgroundColor: '#fdca40', }, headerTintColor: 'black', }} />
