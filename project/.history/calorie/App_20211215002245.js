...
function DetailsScreen({navigation,route}){
    ...
    return(
      <SafeAreaView style={styles.container}>
         ...
         <View style={[,{display:'flex', alignItems:'center', borderRadius:20, backgroundColor: '#6dbc4e',marginVertical:10,marginHorizontal:5,padding:2}]}>
...
export default function App({navigation}) {
  return (
    ...
    <Drawer.Navigator drawerContent={props => <DrawerContent {... props}/>}>
        ...
        <Drawer.Screen name="Details" component={DetailsScreen} options={{headerStyle: {backgroundColor: '#fdca40',},headerTintColor: 'black',}}/>
      </Drawer.Navigator>
