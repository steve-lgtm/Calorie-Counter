  ...
  return(
    <View style={styles.container}>
      ...
      <View style={[, { display: 'flex', flexDirection: 'row', justifyContent: 'space-around',marginTop:20 }]}>
        ...
        <TouchableOpacity onPress={()=>} style={[, { display: 'flex', height: 72, width: 190, alignItems: 'center', borderRadius: 10, backgroundColor: '#6dbc4e', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="check" color={"white"} size={70} />
