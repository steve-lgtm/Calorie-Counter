...
function OverviewTabScreen({ navigation }) {
 ...
 {day}, {diaryKeyDate.toString().substr(8, 2)}. {(diaryKeyDate.getMonth())+1}.</Text>
      ...
      <View style={{display: 'flex',marginTop:15,height:90,width:420,justifyContent:'space-evenly',flexDirection:'row'}}>
       ...
       <View style={{display:'flex',flexDirection:'row',justifyContent:'space-between'}}><Text style={{paddingLeft:5,fontSize:29,  color:'white'}}>{total} kcal</Text><MaterialCommunityIcons style={{}} name="plus-circle" color={"green"} size={20} />
</View>
        </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={()=>navigation.navigate('Search')}>
      ...
      <View style={{display:'flex', flexDirection:'row', justifyContent:'center',width:420,height:200}}>
       ...
       backgroundColor={'black'}
                ...
                return <Text style={{fontSize: 25, color:'black'}}>{(100*(total/goalEnergy)).toFixed()} %</Text>;
                }}
            />
             </View>
            <View style={{display:'flex',justifyContent:'center', alignItems:'center',width:220}}>
            <Text style={{color:'lightgray',fontSize:18}}>Total</Text>
              <Text style={{color:'white',fontSize:30}}>{total} kcal</Text>
      ...
      <View style={{marginLeft:-35}}>
       ...
       style={{}}
            ...
            <Text style={{color:'lightgray',fontSize:10}}>Total</Text>
              <Text style={{color:'white',fontSize:18}}>{total} kcal</Text>
              <Text style={{color:'lightgray',fontSize:13}}>of {goalEnergy} kcal</Text>
       ...
       style={{}}
            ...
            />
             <View style={{display:'flex',justifyContent:'center', alignItems:'flex-start',marginLeft:-20}}>
            <Text style={{color:'lightgray',fontSize:10}}>Total</Text>
              <Text style={{color:'white',fontSize:18}}>{total} kcal</Text>
              <Text style={{color:'lightgray',fontSize:13}}>of {goalEnergy} kcal</Text>
