...
function OverviewTabScreen({ navigation }) {
 ...
 {day}, {diaryKeyDate.toString().substr(8, 2)}. {(diaryKeyDate.getMonth())+1}.</Text>
      ...
      <View style={{display: 'flex',marginTop:15,height:90,width:420,justifyContent:'space-evenly',flexDirection:'row'}}>
       ...
       <Text style={{paddingLeft:5,fontSize:30, display:'flex',flexDirection:'column'}}>{total} kcal      <MaterialCommunityIcons style={{marginBottom:15}} name="calendar" color={"white"} size={15} />
</Text>
        </View>
      ...
      <View style={{display: 'flex',marginTop:15,height:90,width:420,justifyContent:'space-evenly',flexDirection:'row'}}>
        <View style={{backgroundColor:'red',height:80,width:180,margin:5,borderRadius:20}}>
