...
function SearchScreen({ navigation, route }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity onPress={onSubmit} style={{ display: 'flex', height: 49, width: 100,marginLeft:10,marginTop:20,borderRadius:20, justifyContent: 'center', alignItems: 'center',  borderWidth:0.5,borderColor:'white', backgroundColor: 'black', }}><Text style={{color:'green'}}>{t("Submit")}</Text></TouchableOpacity>
      </View>
