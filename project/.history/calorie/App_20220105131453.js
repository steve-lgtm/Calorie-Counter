...
function OverviewTabScreen({ navigation }) {
  ...
  let goalEnergyTotal = total
  if(total>goalEnergy)
  goalEnergyTotal=goalEnergy
  ...
  const pieData = [
    {value: goalEnergyTotal, color: '#177AD5'},
    {value: goalEnergy-total, color: 'lightgray'}
];
      ...
      />
       ...
       style={{}}
            ...
            <PieChart
                ...
                data={pieData}
                centerLabelComponent={() => {
                return <Text style={{fontSize: 10, color:'black'}}>70%</Text>;
                }}
            />
    </View>
    </View>
