...
function MyTabs() {
  ...
  return (
    <Tab.Navigator  screenOptions={options = {tabBarItemStyle:{backgroundColor:'black',borderColor:'black'}, tabBarActiveBackgroundColor:'#fdca40',tabBarLabelStyle: {color:'white',  fontSize: 13 }, tabBarStyle: { height: 60,borderColor:'black',borderTopWidth: 0, borderTopColor: "transparent", }, tabBarShowLabel: true, tabBarLabelPosition: "below-icon" }}>
      <Tab.Screen options={{
        headerShown: false,
        tabBarIcon: () => (
