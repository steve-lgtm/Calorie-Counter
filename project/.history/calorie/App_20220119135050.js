  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={[, { display: 'flex', borderRadius: 10,width:400, backgroundColor: '#6dbc4e', marginVertical: 10, marginHorizontal: 5, padding: 2 }]}>
        ...
        <View style={[, { margin: 5, display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly', alignItems: 'center' }]}>
          <TextInput  onChangeText={text => setText(text)} keyboardType='numeric'  placeholderTextColor={'lightgrey'} placeholder={t('Calorie')} style={{paddingLeft:20, width: 380,borderRadius:10,marginTop:10, marginBottom: 15, color: 'black', fontSize: 16, backgroundColor: 'white', borderTopWidth: 0.5, borderBottomWidth: 0.2 }}>{energy}</TextInput>
