  ...
  return(
    <View style={styles.container}>
      <View style={{display:'flex',backgroundColor:'red',width:400, marginTop:20,}}>
        ...
        <TextInput textAlign={'center'} autoFocus={true}  placeholderTextColor={'white'} placeholder={'Search for food'} style={{ width: 400,borderRadius:20,marginBottom: 15, color: 'black', fontSize: 16, backgroundColor: 'lightgrey', borderTopWidth: 0.5, borderBottomWidth: 0.2 }}/>
      </View>
    </View>
  )
}
