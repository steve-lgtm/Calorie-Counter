...
import { createDrawerNavigator, DrawerContentScrollView,createStackNavigator, DrawerItemList} from '@react-navigation/drawer';
...
const diaryCtx = {
  ...
  return (
    ...
    <Drawer.Navigator drawerContent={props => <DrawerContent {... props}/>}>
        ...
        <Drawer.Screen screenOptions={{ presentation: 'modal' }} name="barcode" component={Barcode} options={{headerStyle: {backgroundColor: '#fdca40',},headerTintColor: 'black',}}/>
