      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <View style={{display:'flex',flexDirection:'row'}}>
            <TouchableOpacity onPress={() => setModalVisible(!modalVisible)} style={[, { display: 'flex',flexDirection:'row',justifyContent:'center', height: 75, width: 100, alignItems: 'center', borderRadius: 10, backgroundColor: '#6dbc4e', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="cancel" color={"red"} size={50} />
          <Text style={{color:'white',marginLeft:5}}>{t("Update")}</Text>

        </TouchableOpacity>

        <TouchableOpacity onPress={onPress1} style={[, { display: 'flex',flexDirection:'row',justifyContent:'center', height: 75, width: 100, alignItems: 'center', borderRadius: 10, backgroundColor: '#6dbc4e', marginVertical: 10, marginHorizontal: 5 }]} >
