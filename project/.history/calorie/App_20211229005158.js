...
import { Button, View, Text, StyleSheet, StatusBar, Pressable, TextInput, FlatList, TouchableOpacity, AppRegistry, Component } from 'react-native';
...
const diaryCtx = {
  ...
  return (
    ...
    <Drawer.Navigator drawerContent={props => <DrawerContent {... props}/>}>
        ...
        <Drawer.Screen name="barcode" component={ScanBarcodeApp} options={{headerStyle: {backgroundColor: '#fdca40',},headerTintColor: 'black',}}/>
