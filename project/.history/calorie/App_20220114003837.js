...
const [nameofactivity,setName]=('')
const [calorieenergy,setCalorie]=('')
  ...
  console.log(nameofactivity,calorieenergy)
  return(
    <View style={styles.container}>
      ...
      <View style={{display:'flex',width:400, marginTop:20,}}>
        ...
        <TextInput  onChange={handleTextCalorie}  placeholderTextColor={'lightgrey'} placeholder={'Calorie'} style={{paddingLeft:20, width: 400,borderRadius:10,marginTop:10, marginBottom: 15, color: 'black', fontSize: 16, backgroundColor: 'white', borderTopWidth: 0.5, borderBottomWidth: 0.2 }}/>
      </View>
