    ...
    return(
      <SafeAreaView style={styles.container}>
         ...
         <View style={[,{margin:5,display:'flex',flexDirection:'row',justifyContent:'space-evenly',alignItems:'center'}]}>
          <TextInput placeholderTextColor={'black'} value={1}keyboardType='numeric' textAlign={'center'} style={[,{backgroundColor:'#6dbc4e',borderBottomWidth:1, color:'black',height:40, width:70}]}></TextInput>
