...
function MyTabs() {
  ...
  return (
    <Tab.Navigator screenOptions={options = { tabBarLabelStyle: {color:'black', fontSize: 13 }, tabBarStyle: { height: 60 }, tabBarShowLabel: true, tabBarLabelPosition: "below-icon" }}>
      <Tab.Screen options={{
        headerShown: false,
        tabBarIcon: () => (
