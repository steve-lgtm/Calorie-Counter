...
function SearchScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TextInput blurOnSubmit={true} textAlign={'center'} onSubmitEditing={onSubmit} placeholderTextColor={'black'} placeholder={'Search for food'} style={{ marginTop:1,marginBottom:5,color: 'black', fontSize: 16, backgroundColor:'white', borderTopWidth:0.5, borderBottomWidth:0.2 }}/>
      <View >
      <FlatList
        data={results}
        renderItem={({ item }) => {
