...
function OverviewTabScreen({ navigation }) {
 ...
 {day}, {diaryKeyDate.toString().substr(8, 2)}. {(diaryKeyDate.getMonth())+1}.</Text>
      ...
      <View style={{display: 'flex',marginTop:15,height:100,width:420,justifyContent:'space-evenly',flexDirection:'row'}}>
       ...
       <Text style={{paddingLeft:5,fontSize:30}}>{total} kcal</Text>
        </View>
        <View style={{backgroundColor:'yellow',height:90,width:180,margin:5,borderRadius:20}}>

        </View>
      </View>
      <View style={{display: 'flex',marginTop:15,height:100,width:420,justifyContent:'space-evenly',flexDirection:'row'}}>
        <View style={{backgroundColor:'red',height:90,width:180,margin:5,borderRadius:20}}>
