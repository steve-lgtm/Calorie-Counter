  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity onPress={onPress1} style={[, { display: 'flex',flexDirection:'row',justifyContent:'center', height: 75, width: 100, alignItems: 'center', borderRadius: 10, borderWidth:0.5,backgroundColor: 'black',borderColor:'white', marginVertical: 10, marginHorizontal: 5 }]} >
