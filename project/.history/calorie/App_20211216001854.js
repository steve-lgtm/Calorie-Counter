...
function DetailsScreen({navigation,route}){
  const [selectedweight, setSelectedweight] = useState(100);
    ...
    const catbohydrates = food.catbohydrates_total_g
    console.log(catbohydrates)
  ...
  <Picker.Item label="1 g" value={1} />
         ...
         <Text style={[,{color:'white',fontSize:16,margin:5 }]}>Bielkoviny</Text>
         <Text style={[,{color:'white',fontSize:16, }]}>{protein} g</Text>
         ...
         <View style={[,{justifyContent:'center',alignItems:'center'}]}>
          ...
          <Text style={[,{color:'white',fontSize:16,margin:5 }]}>Sacharidy</Text>
         <Text style={[,{color:'white',fontSize:16, }]}>{catbohydrates} g</Text>
         </View>
         </View>
