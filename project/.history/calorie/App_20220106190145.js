...
function OverviewTabScreen({ navigation }) {
 ...
 {day}, {diaryKeyDate.toString().substr(8, 2)}. {(diaryKeyDate.getMonth())+1}.</Text>
      ...
      <View style={{display:'flex', flexDirection:'row', justifyContent:'space-around',width:420,height:200,backgroundColor:'red'}}>
       <View style={{display:'flex',justifyContent:'flex-start',marginLeft:-60,marginRight:400}}>
       <PieChart
       style={{}}
