...
function MyTabs() {
  ...
  return (
    <Tab.Navigator screenOptions={options = {tabBarActiveBackgroundColor:'#fdca40',tabBarItemStyle:{backgroundColor:'gray'}, tabBarLabelStyle: {color:'white',  fontSize: 13 }, tabBarStyle: { height: 60 }, tabBarShowLabel: true, tabBarLabelPosition: "below-icon" }}>
      <Tab.Screen options={{
        headerShown: false,
        tabBarIcon: () => (
