...
function OverviewTabScreen({ navigation }) {
  ...
  let colorEnergy,colorProtein = 'lightgray'
    ...
    <View style={{display:'flex', flexDirection:'row', marginTop:-25}}>
      <View style={{marginLeft:-35}}>
       ...
       style={{}}
                ...
                data={EnergyData}
                centerLabelComponent={() => {
                return <Text style={{fontSize: 10, color:'black'}}>{(100*(totalEnergy/goalEnergy)).toFixed()} %</Text>;
                }}
            />
             <View style={{display:'flex',justifyContent:'center', alignItems:'flex-start',marginLeft:-15}}>
            <Text style={{color:'lightgray',fontSize:10}}>Total</Text>
              <Text style={{color:'white',fontSize:18}}>{totalEnergy} kcal</Text>
