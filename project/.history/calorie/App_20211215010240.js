...
import { Button, View, Text, StyleSheet, StatusBar, Pressable, TextInput, FlatList, Picker } from 'react-native';
    ...
    return(
      <SafeAreaView style={styles.container}>
         ...
         <View style={[,{margin:5,display:'flex',flexDirection:'row',justifyContent:'space-evenly',alignItems:'center'}]}>
          <TextInput placeholderTextColor={'black'} keyboardType='numeric' textAlign={'center'} style={[,{backgroundColor:'#6dbc4e',borderBottomWidth:1, color:'black',height:40, width:70}]}></TextInput>
          <Text style={[,{fontSize:15}]}>X</Text>
          <TextInput style={[,{backgroundColor:'white',height:40, width:230}]}></TextInput>
          <Picker
        selectedValue={selectedValue}
        style={{ height:40, width:230,backgroundColor:'#6dbc4e' }}
