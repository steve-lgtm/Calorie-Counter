...
function MyTabs() {
  ...
  return (
    <Tab.Navigator tabBarOptions={{showLabel:false,}} screenOptions={  options={tabBarStyle: {height: 60,fontSize:30},tabBarShowLabel:true,tabBarLabelPosition:"below-icon"}}>
