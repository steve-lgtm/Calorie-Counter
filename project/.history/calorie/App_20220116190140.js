      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <TextInput autoFocus={true}  placeholderTextColor={'lightgrey'} placeholder={'Activity'} style={{paddingLeft:20, width: 200,borderRadius:10,marginTop:10, marginBottom: 15, color: 'black', fontSize: 16, backgroundColor: 'white', borderTopWidth: 0.5, borderBottomWidth: 0.2 }}/>
