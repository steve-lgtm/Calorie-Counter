...
function OverviewTabScreen({ navigation }) {
 ...
 {day}, {diaryKeyDate.toString().substr(8, 2)}. {(diaryKeyDate.getMonth())+1}.</Text>
      ...
      <View style={{display: 'flex',marginTop:15,height:90,width:420,justifyContent:'space-evenly',flexDirection:'row'}}>
       ...
       <View style={{display:'flex',flexDirection:'row',justifyContent:'space-between'}}><Text style={{paddingLeft:5,fontSize:30,  color:'white'}}>{total} kcal</Text><MaterialCommunityIcons style={{}} name="plus-circle" color={"white"} size={20} />
</View>
        </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={()=>navigation.navigate('Search')}>
       ...
       <View style={{display:'flex',flexDirection:'row',justifyContent:'space-between'}}><Text style={{paddingLeft:5,fontSize:30,  color:'white'}}>0 kcal</Text><MaterialCommunityIcons style={{}} name="plus-circle" color={"white"} size={20} />
</View>
        </View>
        </TouchableOpacity>
      </View>
      ...
      <TouchableOpacity onPress={()=>navigation.navigate('Search')}>
       ...
       <View style={{display:'flex',flexDirection:'row',justifyContent:'space-between'}}><Text style={{paddingLeft:5,fontSize:30,  color:'white'}}>0 kcal</Text><MaterialCommunityIcons style={{}} name="plus-circle" color={"white"} size={20} />
        ...
        <View style={{backgroundColor:'black',borderColor:'white',borderWidth:0.5, height:90,width:190,margin:5,borderRadius:20, padding:10,display:'flex',justifyContent:'space-between'}}>
       <Text style={{color:'grey',paddingLeft:5,fontSize:15}}>Homtonosť</Text>
       <View style={{display:'flex',flexDirection:'row',justifyContent:'space-between'}}><Text style={{paddingLeft:5,fontSize:30,  color:'white'}}>0 kcal</Text><MaterialCommunityIcons style={{}} name="plus-circle" color={"lightgreen"} size={20} />
</View>
        </View>
        </TouchableOpacity>
      </View>
