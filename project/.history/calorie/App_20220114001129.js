...
const haha=''
  return(
    <View style={styles.container}>
      ...
      <View style={[, { display: 'flex', flexDirection: 'row', justifyContent: 'space-around' }]}>
        <TouchableOpacity onPress={() => navigation.navigate('')} style={[, { display: 'flex', height: 72, width: 190, alignItems: 'center', borderRadius: 10, backgroundColor: '#6dbc4e', marginVertical: 10, marginHorizontal: 20 }]} >
          <MaterialCommunityIcons name="cancel" color={"red"} size={70} />
