...
function MyTabs() {
  ...
  return (
    <Tab.Navigator screenOptions={options = {tabBarItemStyle:{backgroundColor:'black',borderColor:'black'}, tabBarActiveBackgroundColor:'#fdca40',tabBarLabelStyle: {color:'white',  fontSize: 13 }, tabBarStyle: { height: 70,borderColor:'black' }, tabBarShowLabel: true, tabBarLabelPosition: "below-icon" }}>
      <Tab.Screen options={{
        headerShown: false,
        tabBarIcon: () => (
