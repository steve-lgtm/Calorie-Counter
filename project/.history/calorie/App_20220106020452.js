...
function OverviewTabScreen({ navigation }) {
 ...
 {day}, {diaryKeyDate.toString().substr(8, 2)}. {(diaryKeyDate.getMonth())+1}.</Text>
      ...
      <View style={{display: 'flex',height:100,width:420,justifyContent:'space-evenly',flexDirection:'row'}}>
        <View style={{backgroundColor:'red',height:90,width:180,margin:5,borderRadius:30}}>

        </View>
        <View style={{backgroundColor:'yellow',height:90,width:180,margin:5,borderRadius:30}}>

        </View>
      </View>
      <View style={{display: 'flex',height:100,width:420,backgroundColor:'white',justifyContent:'space-evenly',flexDirection:'row'}}>
        <View style={{backgroundColor:'red',height:90,width:180,margin:5,borderRadius:30}}>
