...
function SettingsScreen({navigation}){
  ...
  const [selectedGoal, setSelectedGoal] = useState();
    ...
    return(
      ...
      >
        <View style={styles.centeredView}>
          ...
          <Picker.Item label="Gain muscle" value={100} />
          <Picker.Item label="Be fit" value={1} />
          <Picker.Item label='Lose weight' value={200} />
        ...
        <View style={{display:'flex',flexDirection:'row',justifyContent:'center',alignItems:'center', marginBottom:20}}>
          <Text style={{color:'white',fontSize:15,marginRight:20,marginBottom:10}}>Energy</Text>
            <TextInput onChangeText={text => setWeight(text)} autoFocus={true}  placeholderTextColor={'lightgrey'} placeholder={'Energy (Kcal)'} style={{paddingLeft:20, width: 200,borderRadius:10,marginTop:10, marginBottom: 15, color: 'black', fontSize: 16, backgroundColor: 'white', borderTopWidth: 0.5, borderBottomWidth: 0.2 }}/>
            </View>
            <View style={{display:'flex',flexDirection:'row'}}>
    ...
    <TouchableOpacity style={{display:'flex',marginTop:1,paddingLeft:20,justifyContent:'center',backgroundColor:'black',width:420,height:60,borderBottomWidth:0.5,borderColor:'white' }}  >
