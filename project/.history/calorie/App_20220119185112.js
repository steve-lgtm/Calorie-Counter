      ...
      >
        ...
        <View style={{display:'flex',flexDirection:'row',justifyContent:'center',alignItems:'center', marginBottom:20}}>
          <Text style={{color:'white',fontSize:15,marginRight:20,marginBottom:10}}>{t("Energy")}</Text>
            ...
            <View style={{display:'flex',flexDirection:'row'}}>
            <TouchableOpacity onPress={onPress3} style={[, { display: 'flex',  flexDirection:'row',justifyContent:'center',height: 65, width: 150, alignItems: 'center', borderRadius: 10, borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="cancel" color={"red"} size={40} />
          <Text style={{color:'white',marginLeft:5}}>{t("Cancel")}</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={onPress1} style={[, { display: 'flex',  flexDirection:'row',justifyContent:'center',height: 65, width: 150, alignItems: 'center', borderRadius: 10, borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="check" color={"white"} size={40} />
      ...
      >
        ...
        <View style={{display:'flex',flexDirection:'row',justifyContent:'flex-end',alignItems:'center', marginBottom:20}}>
          ...
          <Text style={{color:'white',fontSize:15,marginRight:20,marginBottom:10}}>{t("Fiber")}</Text>
            ...
            <TouchableOpacity onPress={() => setModal2Visible(!modal2Visible)} style={[, { display: 'flex', flexDirection:'row',justifyContent:'center', height: 65, width: 160, alignItems: 'center', borderRadius: 10, borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="cancel" color={"red"} size={40} />
          <Text style={{color:'white',marginLeft:5}}>{t("Cancel")}</Text>

        </TouchableOpacity>

        <TouchableOpacity onPress={onPress2} style={[, { display: 'flex',  flexDirection:'row',justifyContent:'center',height: 65, width: 160, alignItems: 'center', borderRadius: 10, borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="check" color={"white"} size={40} />
