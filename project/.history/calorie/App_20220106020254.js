...
function OverviewTabScreen({ navigation }) {
 ...
 {day}, {diaryKeyDate.toString().substr(8, 2)}. {(diaryKeyDate.getMonth())+1}.</Text>
      ...
      <View style={{display: 'flex',height:200,width:420,backgroundColor:'white',justifyContent:'space-evenly',flexDirection:'row'}}>
        <View style={{backgroundColor:'red',height:90,width:170,margin:5,borderRadius:30}}>

        </View>
        <View style={{backgroundColor:'yellow',height:90,width:170,margin:5,borderRadius:30}}>
