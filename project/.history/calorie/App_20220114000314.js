  ...
  return(
    <View style={styles.container}>
      <View style={{display:'flex',backgroundColor:'red',width:400, marginTop:20,}}>
        ...
        <TextInput autoFocus={true}  placeholderTextColor={'white'} placeholder={'Activity'} style={{paddingLeft:20, width: 400,borderRadius:10,marginTop:5, marginBottom: 15, color: 'black', fontSize: 16, backgroundColor: 'lightgrey', borderTopWidth: 0.5, borderBottomWidth: 0.2 }}/>
      </View>
    </View>
  )
}
