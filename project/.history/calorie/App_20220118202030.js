    ...
    return(
      ...
      >
        ...
        <TouchableOpacity onPress={onPress2} style={[, { display: 'flex', height: 75, width: 150, alignItems: 'center', borderRadius: 10, backgroundColor: '#6dbc4e', marginVertical: 10, marginHorizontal: 5 }]} >
          ...
          <TouchableOpacity  onPress={() => setModal2Visible(true)} style={{display:'flex',paddingLeft:20,justifyContent:'center',backgroundColor:'black',width:420,height:60,borderBottomWidth:0.5,borderColor:'white' }}  >
