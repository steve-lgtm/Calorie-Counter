...
/>
      ...
      <View style={[, { display: 'flex', flexDirection: 'row', justifyContent: 'space-around' }]}>
        <TouchableOpacity onPress={() => navigation.navigate(t('Search'))} style={[, { display: 'flex', height: 72, width: 190, alignItems: 'center', borderRadius: 10,  borderRadius: 10,borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="cancel" color={"red"} size={70} />

        </TouchableOpacity>

        <TouchableOpacity onPress={onAdd} style={[, { display: 'flex', height: 72, width: 190, alignItems: 'center', borderRadius: 10,  borderRadius: 10,borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5 }]} >
