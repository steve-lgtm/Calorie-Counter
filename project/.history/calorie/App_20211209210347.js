...
function MyTabs() {
  ...
  return (
    <Tab.Navigator tabBarOptions={{showLabel:false,}} screenOptions={  options={tabBarLabelStyle: {fontSize:12},tabBarStyle: {height: 60},tabBarShowLabel:true,tabBarLabelPosition:"below-icon"}}>
