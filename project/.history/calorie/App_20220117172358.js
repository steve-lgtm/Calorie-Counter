...
function WeightProgressScreen({ navigation, route }) {
  ...
  console.log(new Date().getDate()-1,new Date().getMonth()+1)

  let dates=[]
 for(let i=1;dates.length>=5||i>=10;i++)
    let datum=today.getDate()-i
    dates.push(datum)
  }
  console.log(dates)
  const data = {
    ...
    datasets: [
      {
        data: [20, 45, 28, 80, 99, 43,55,2,3,4,6,7,8,3,6,7],
