...
const[responses,setResponses]=useState()
 ...
 let fess= yesterday.setDate(yesterday.getDate() - 1)
  let yest =yesterday.setDate(yesterday.getDate() - 2)
  console.log(fess,yest)

  useEffect(() => {
    AsyncStorage
      .multiGet([fess.getTime().toString(),yest.getTime().toString()])
      .then(diary => {
