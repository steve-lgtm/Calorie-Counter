...
const FiberData = [
 ...
 {day}, {diaryKeyDate.toString().substr(8, 2)}. {(diaryKeyDate.getMonth())+1}.</Text>
      ...
      <TouchableOpacity onPress={()=>navigation.navigate('Search')}>
       ...
       <View style={{display:'flex',flexDirection:'row',justifyContent:'space-between'}}><Text style={{paddingLeft:5,fontSize:29,  color:'white'}}>0 kg</Text><MaterialCommunityIcons style={{}} name="plus-circle" color={"green"} size={20} />
</View>
        </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={()=>navigation.navigate('Search')}>
...
function onAdd(e) {
 let text= e.nativeEvent.text.toString()
 console.log(text)
}
  return(
    <View style={styles.container}>
      <View style={{display:'flex',width:400, marginTop:20,}}>
        ...
        <TextInput autoFocus={true}  placeholderTextColor={'lightgrey'} placeholder={'Activity'} style={{paddingLeft:20, width: 400,borderRadius:10,marginTop:10, marginBottom: 15, color: 'black', fontSize: 16, backgroundColor: 'white', borderTopWidth: 0.5, borderBottomWidth: 0.2 }}/>
      </View>
      <View style={{display:'flex',width:400, marginTop:20,}}>
        <Text style={{color:'lightgrey',fontSize:20}}>Calorie (Energy in kcal):</Text>
        <TextInput autoFocus={true}  placeholderTextColor={'lightgrey'} placeholder={'Calorie'} style={{paddingLeft:20, width: 400,borderRadius:10,marginTop:10, marginBottom: 15, color: 'black', fontSize: 16, backgroundColor: 'white', borderTopWidth: 0.5, borderBottomWidth: 0.2 }}/>
      </View>
      <View style={[, { display: 'flex', flexDirection: 'row', justifyContent: 'space-around',marginTop:20 }]}>
        ...
        <TouchableOpacity onPress={onAdd(e)} style={[, { display: 'flex', height: 72, width: 190, alignItems: 'center', borderRadius: 10, backgroundColor: '#6dbc4e', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="check" color={"white"} size={70} />
