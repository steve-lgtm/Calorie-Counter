...
function SettingsScreen({navigation}){
  ...
  const diaryyy = useContext(ctx.Diary);
    ...
    return(
      <View style={styles.container}>
          <TouchableOpacity style={{display:'flex',paddingLeft:20,justifyContent:'center',backgroundColor:'red',width:420,height:70,borderBottomWidth:0.5,borderColor:'white'
      }}  >

      <Text style={{fontSize:20}}>djkhfjk</Text>
