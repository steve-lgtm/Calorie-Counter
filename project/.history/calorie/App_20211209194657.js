...
const Tab = createBottomTabNavigator(tabBarOptions: {
...
function MyTabs() {
  ...
  return (
    <Tab.Navigator screenOptions={ options={tabBarShowLabel:true, tabBarLabelPosition:"beside-icon"}}>
      <Tab.Screen options={{headerShown:false}} name="Overview" component={OverviewTabScreen} />
