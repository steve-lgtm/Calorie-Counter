...
function DetailsScreen({navigation,route}){
  ...
  <Picker.Item label="1 g" value={1} />
         ...
         <View style={[,{display:'flex', flexDirection:'row', borderRadius:10, backgroundColor: '#6dbc4e',marginVertical:10,marginHorizontal:5,padding:2}]}>
         <View>
         <Text style={[,{color:'white',fontSize:16}]}>Energia</Text>

         </View>
         <View style={[,{margin:5,display:'flex',flexDirection:'row',justifyContent:'space-evenly',alignItems:'center'}]}>
          <Text style={[,{color:'white',margin:10,fontSize:16}]}>Energia</Text>
         </View>
         </View>
