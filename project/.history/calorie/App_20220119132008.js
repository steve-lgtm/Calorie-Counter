...
function SearchScreen({ navigation, route }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Pressable onPress={onSubmit} style={{ display: 'flex', height: 49, width: 100,marginLeft:10,marginTop:20,borderRadius:20, justifyContent: 'center', alignItems: 'center', backgroundColor: 'green' }}><Text style={{color:'white'}}>{t("Submit")}</Text></Pressable>
      </View>
