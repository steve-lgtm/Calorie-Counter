  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity onPress={() => diaryyy.weight(weight)} style={[, { display: 'flex', height: 75, width: 100, alignItems: 'center', borderRadius: 10, backgroundColor: '#6dbc4e', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="check" color={"white"} size={70} />
