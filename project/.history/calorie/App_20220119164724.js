      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <View style={{display:'flex',flexDirection:'row'}}>
            <TouchableOpacity onPress={() => setModalVisible(!modalVisible)} style={[, { display: 'flex',flexDirection:'row',justifyContent:'center', height: 75, width: 100, alignItems: 'center',borderWidth:0.5, borderRadius: 10, borderColor:'white',backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="cancel" color={"red"} size={50} />
          <Text style={{color:'white',marginLeft:5}}>{t("Update")}</Text>
