...
function DetailsScreen({navigation,route}){
  ...
  <Picker.Item label="1 g" value={1} />
         ...
         <TouchableOpacity onPress={()=>nav} style={[,{display:'flex', height:72, width:190, alignItems:'center', borderRadius:10, backgroundColor: '#6dbc4e',marginVertical:10,marginHorizontal:5}]} >
