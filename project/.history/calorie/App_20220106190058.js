...
function OverviewTabScreen({ navigation }) {
 ...
 {day}, {diaryKeyDate.toString().substr(8, 2)}. {(diaryKeyDate.getMonth())+1}.</Text>
      ...
      <View style={{display:'flex', flexDirection:'row', justifyContent:'space-between',width:420,height:200,backgroundColor:'red'}}>
       <View style={{display:'flex',justifyContent:'flex-start',marginLeft:-100,marginRight:-20}}>
       <PieChart
       style={{}}
       backgroundColor={'black'}
            ...
            <View style={{display:'flex',justifyContent:'center', alignItems:'center',backgroundColor:'yellow'}}>
              <Text>Total</Text>
            </View>
