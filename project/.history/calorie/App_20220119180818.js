...
function MyTabs() {
  ...
  return (
    <Tab.Navigator  screenOptions={options = {tabBarItemStyle:{backgroundColor:'#fdca40',borderColor:'black'}, tabBarActiveBackgroundColor:'#fdca40',tabBarLabelStyle: {color:'black',  fontSize: 13,marginTop:-10,marginBottom:5 }, tabBarStyle: { height: 60,borderColor:'black',borderTopWidth: 0, borderTopColor: "transparent", }, tabBarShowLabel: true, tabBarLabelPosition: "below-icon" }}>
      <Tab.Screen options={{
        headerShown: false,
        tabBarIcon: () => (
