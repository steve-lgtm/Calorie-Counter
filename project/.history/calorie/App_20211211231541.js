...
function SearchScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TextInput  onSubmitEditing={onSubmit} placeholder={'search for food'} style={{ color: 'cyan', fontSize: 32, backgroundColor:'grey', borderRadius:10   }}/>
      <View >
      <FlatList
        data={results}
        renderItem={({ item }) => {
...
const styles = StyleSheet.create({
  container: { flex: 1, flexDirection:'' },
  container2: {
    flex: 1,
