...
function MenuTabScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={[styles.container, {}]}>
      ...
      <TouchableOpacity style={[styles.btn,{flex: 1,}]} onPress={onPress}>


        <Text style={[styles.text, {  textAlign:'center', marginLeft:20 }]}><MaterialCommunityIcons name="calendar" color={"white"} size={30} />
  ...
  return (
    <View style={styles.container}>
      ...
      <MaterialCommunityIcons name="calendar" color={"white"} size={30} />
        <Text style={[styles.text, { flex: 1, textAlign:'center', marginLeft:20 }]}>
 {day}, {diaryKeyDate.toString().substr(8, 2)}. {(diaryKeyDate.getMonth())+1}.</Text>
        <TouchableOpacity style={styles.btn} onPress={onPress}>
          <Text styles={styles.text}>Change</Text>
        </TouchableOpacity>
      </View>
