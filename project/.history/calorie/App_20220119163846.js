...
/>
      ...
      <View style={[, { display: 'flex', flexDirection: 'row', justifyContent: 'space-around' }]}>
        ...
        <TouchableOpacity onPress={onUpdate} style={[, { display: 'flex',flexDirection:'row', height: 72, width: 190, alignItems: 'center', borderRadius: 10, borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5 }]} >
