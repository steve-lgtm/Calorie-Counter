      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <TextInput autoFocus={true}  placeholderTextColor={'lightgrey'} placeholder={'Weight (Kg)'} style={{paddingLeft:20, width: 200,borderRadius:10,marginTop:10, marginBottom: 15, color: 'black', fontSize: 16, backgroundColor: 'white', borderTopWidth: 0.5, borderBottomWidth: 0.2 }}/>
            <View style={{display:'flex',flexDirection:'row'}}>
            <TouchableOpacity onPress={() => navigation.navigate('Overview')} style={[, { display: 'flex', height: 75, width: 100, alignItems: 'center', borderRadius: 10, backgroundColor: '#6dbc4e', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="cancel" color={"red"} size={70} />

        </TouchableOpacity>

        <TouchableOpacity  style={[, { display: 'flex', height: 75, width: 100, alignItems: 'center', borderRadius: 10, backgroundColor: '#6dbc4e', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="check" color={"white"} size={70} />
