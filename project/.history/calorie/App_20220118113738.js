...
const[day,setDay]=useState(yesterday.getTime().toString())
...
for(let i=1;i<5;i++){
  ...
  console.log(yesterday.setDate(yesterday.getDate()-i).getTime().toString())
  setDay(yesterday.setDate(yesterday.getDate()-i).getTime().toString())
