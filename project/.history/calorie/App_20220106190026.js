...
function OverviewTabScreen({ navigation }) {
 ...
 {day}, {diaryKeyDate.toString().substr(8, 2)}. {(diaryKeyDate.getMonth())+1}.</Text>
      ...
      <View style={{display:'flex', flexDirection:'row', justifyContent:'space-evenly',width:420,height:200,backgroundColor:'red'}}>
       <View style={{display:'flex',justifyContent:'flex-start',marginLeft:-100,marginRight:-40}}>
       <PieChart
       style={{}}
