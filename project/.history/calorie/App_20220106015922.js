...
function OverviewTabScreen({ navigation }) {
 ...
 {day}, {diaryKeyDate.toString().substr(8, 2)}. {(diaryKeyDate.getMonth())+1}.</Text>
      ...
      <View style={{display: 'flex',height:200,width:420,backgroundColor:'white',justifyContent:'space-between',flexDirection:'row'}}>
        <View style={{backgroundColor:'red',height:90,width:110}}>

        </View>
        <View style={{backgroundColor:'yellow',height:90,width:110}}>
