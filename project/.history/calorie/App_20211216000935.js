...
function DetailsScreen({navigation,route}){
  const [selectedweight, setSelectedweight] = useState(100);
    ...
    const energy = food.calories
    const energy = (food.calories*4.184).toFixed
    console.log(food)
    return(
  ...
  <Picker.Item label="1 g" value={1} />
         ...
         <Text style={[,{color:'white',fontSize:16, margin:5}]}>{energy} kcal</Text>


         </View>
         <View style={[,{justifyContent:'center',alignItems:'center'}]}>
          <Text style={[,{color:'white',fontSize:16, margin:10}]}>Energia</Text>
          <Text style={[,{color:'white',fontSize:16, margin:5}]}>{energy*4.184} kJ</Text>
         </View>
         </View>
