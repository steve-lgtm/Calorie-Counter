...
function SearchScreen({ navigation, route }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Pressable onPress={onSubmit} style={{ display: 'flex', height: 50, width: 100, justifyContent: 'center', alignItems: 'center', backgroundColor: 'green' }}><Text style={{}}>Submit</Text></Pressable>
      </View>
