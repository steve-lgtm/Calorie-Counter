...
function DetailsScreen({navigation,route}){
  ...
  <Picker.Item label="1 g" value={1} />
         ...
         <View style={[,{width:72,display:'flex', justifyContent:'space-around', flexDirection:'row', borderRadius:10, backgroundColor: '#6dbc4e',marginVertical:10,marginHorizontal:5,padding:2}]}>
