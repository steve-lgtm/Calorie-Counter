...
function OverviewTabScreen({ navigation }) {
 ...
 {day}, {diaryKeyDate.toString().substr(8, 2)}. {(diaryKeyDate.getMonth())+1}.</Text>
      ...
      <View style={{display: 'flex',marginTop:15,height:90,width:420,justifyContent:'space-evenly',flexDirection:'row'}}>
        ...
        <View style={{backgroundColor:'red',height:80,width:180,margin:5,borderRadius:20, padding:10,display:'flex',justifyContent:'space-between'}}>
       <Text style={{color:'black',paddingLeft:5,fontSize:15}}>Príjem</Text>
       <Text style={{paddingLeft:5,fontSize:30, display:'flex',flexDirection:'column', color:'white'}}>{total} kcal      <MaterialCommunityIcons style={{}} name="plus-thick" color={"white"} size={15} />
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('Search')}>
        <View style={{backgroundColor:'red',height:80,width:180,margin:5,borderRadius:20, padding:10,display:'flex',justifyContent:'space-between'}}>
       <Text style={{color:'black',paddingLeft:5,fontSize:15}}>Aktivita</Text>
       <Text style={{paddingLeft:5,fontSize:30, display:'flex',flexDirection:'column', color:'white'}}>{total} kcal      <MaterialCommunityIcons style={{}} name="plus-thick" color={"white"} size={15} />
</Text>
        </View>
        </TouchableOpacity>
      ...
      <TouchableOpacity onPress={()=>navigation.navigate('Search')}>
        <View style={{backgroundColor:'red',height:80,width:180,margin:5,borderRadius:20, padding:10,display:'flex',justifyContent:'space-between'}}>
       <Text style={{color:'black',paddingLeft:5,fontSize:15}}>Homtonosť</Text>
       <Text style={{paddingLeft:5,fontSize:30, display:'flex',flexDirection:'column', color:'white',justifyContent:'space-between'}}>{total} kg <MaterialCommunityIcons style={{}} name="plus-thick" color={"white"} size={15} />
</Text>
        </View>
        </TouchableOpacity>
        <View style={{backgroundColor:'yellow',height:80,width:180,margin:5,borderRadius:20}}>
