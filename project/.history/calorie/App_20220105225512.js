 ...
 color = '#177AD5'
  ...
  return (
    <View style={styles.container}>
      ...
      <MaterialCommunityIcons name="calendar" color={"orange"} size={37} />
<Text style={[styles.text, { flex: 1, textAlign:'center', marginLeft:29 }]}> {day}, {date.toString().substr(8, 2)}. {(date.getMonth())+1}.</Text>
