...
function DetailsScreen({navigation,route}){
  ...
  <Picker.Item label="1 g" value={1} />
         ...
         <TouchableOpacity style={[,{display:'flex', height:100, width:200, alignItems:'center', borderRadius:10, backgroundColor: '#6dbc4e',marginVertical:10,marginHorizontal:5}]} >
           <MaterialCommunityIcons name="fire" color={"orange"} size={100}/>
