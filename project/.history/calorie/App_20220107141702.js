...
function DetailsScreen({ navigation, route }) {
  ...
  return (
    ...
    <View style={[, { display: 'flex', justifyContent: 'space-between', width:400,flexDirection: 'row', borderRadius: 10, backgroundColor: '#6dbc4e', marginVertical: 10, marginHorizontal: 5, padding: 2 }]}>
