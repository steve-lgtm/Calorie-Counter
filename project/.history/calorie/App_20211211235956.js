...
function SearchScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TextInput  onSubmitEditing={onSubmit} placeholder={'search for food'} style={{ color: 'cyan', fontSize: 32, backgroundColor:'white', borderTopWidth:0.5, borderBottomWidth:0.1 }}/>
      <View >
      <FlatList
        data={results}
        renderItem={({ item }) => {
