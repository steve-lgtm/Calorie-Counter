  ...
  React.useLayoutEffect(() => {
    navigation.setOptions({
      headerRight: () => (
        ...
        <Pressable style={[, { marginRight: 10 }]} onPress={() => navigation.navigate(t('Search'))}>
          <MaterialCommunityIcons name="magnify" color={"black"} size={37} />
        </Pressable>
        <Pressable style={[, { marginRight: 10 }]} onPress={() => navigation.navigate(t('Barcode Scanner'))}>
...
function DetailsScreen({ navigation, route }) {
  ...
  return (
    ...
    <View style={[, { display: 'flex', alignItems: 'center', width:400, borderRadius: 10,borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5, padding: 2 }]}>
      <Text style={[, { padding:10,fontSize: 35, color:'white'  }]}>{name}</Text>
    </View>
    <ScrollView>
    <View style={[, { display: 'flex', borderRadius: 10,width:400,borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5, padding: 2 }]}>
      <Text style={[, { color: 'white', margin: 10, fontSize: 16 }]}>{t("Quantity")}</Text>
      <View style={[, { margin: 5, display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly', alignItems: 'center' }]}>
        <TextInput placeholderTextColor={'black'} keyboardType='numeric' textAlign={'center'} autoFocus={true} style={[, { backgroundColor: 'black', borderBottomWidth: 1,borderColor:'white', color: 'white', height: 40, width: 70 }]} onChangeText={text => setText(text)}>1</TextInput>
        <Text style={[, { fontSize: 15 }]}>X</Text>
        <Picker style={[, { backgroundColor: 'black', height: 40, width: 230 }]}
    ...
    <View style={[, { display: 'flex', justifyContent: 'space-around', width:400,flexDirection: 'row', borderRadius: 10,borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5, padding: 2 }]}>
      <View style={[, { justifyContent: 'center', alignItems: 'center' }]}>
        <Text style={[, { color: 'white', fontSize: 16, margin: 10,color:'lightgrey' }]}>{t("Energy")}</Text>
    ...
    <View style={[, { display: 'flex', justifyContent: 'space-around', width:400,flexDirection: 'row', borderRadius: 10,borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5, padding: 2 }]}>
      <View style={[, { justifyContent: 'center', alignItems: 'center',width:150 }]}>
        ...
        <Text style={[, { color: 'white', fontSize: 16, margin: 10 , color:'#2587be' }]}>{t("Protein")}</Text>
        <Text style={[, { color: 'white', fontSize: 16, marginBottom: 5 }]}>{proteinx} g</Text>
        <Text style={[, { color: 'white', fontSize: 16, margin: 10, color:'#49be25'  }]}>{t("Fiber")}</Text>
        <Text style={[, { color: 'white', fontSize: 16, marginBottom: 5 }]}>{fiberx} g</Text>

      </View>
      <View style={[, { justifyContent: 'center', alignItems: 'center',width:150 }]}>

        <Text style={[, { color: 'white', fontSize: 16, margin: 10 ,color: "#fce54e", }]}>{t("Fat")}</Text>
        <Text style={[, { color: 'white', fontSize: 16, marginBottom: 5 }]}>{fatx} g</Text>
        <Text style={[, { color: 'white', fontSize: 16, margin: 10, color:'#be4d25'  }]}>{t("Carbohydrates")}</Text>
...
/>
    ...
    <View style={[, { display: 'flex', flexDirection: 'row', justifyContent: 'space-around' }]}>
      <TouchableOpacity onPress={() => navigation.navigate(t('Search'))} style={[, { display: 'flex',justifyContent:'center',flexDirection:'row', height: 72, width: 190, alignItems: 'center', borderRadius: 10,borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5 }]} >
        <MaterialCommunityIcons name="cancel" color={"red"} size={50} />
        <Text style={{color:'white',marginLeft:5}}>{t("Cancel")}</Text>

      </TouchableOpacity>

      <TouchableOpacity onPress={onAdd} style={[, { display: 'flex', height: 72, width: 190, alignItems: 'center', justifyContent:'center',flexDirection:'row',borderRadius: 10, backgroundColor: 'black', borderWidth:0.5,borderColor:'white',marginVertical: 10, marginHorizontal: 5 }]} >
        <MaterialCommunityIcons name="check" color={"green"} size={50} />
        <Text style={{color:'white',marginLeft:5}}>{t("Add food")}</Text>
...
function DetailsScreenBar({ navigation, route }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
      <View style={[, { display: 'flex', borderRadius: 10,width:400,  borderRadius: 10,borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5, padding: 2 }]}>
        <Text style={[, { color: 'white', margin: 10, fontSize: 16 }]}>{t("Quantity")}</Text>
        <View style={[, { margin: 5, display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly', alignItems: 'center' }]}>
          <TextInput placeholderTextColor={'black'} keyboardType='numeric' textAlign={'center'} autoFocus={true} style={[, { backgroundColor: 'black', borderBottomWidth: 1,borderColor:'white', color: 'white', height: 40, width: 70 }]} onChangeText={text => setText(text)}>1</TextInput>
          <Text style={[, { fontSize: 15 }]}>X</Text>
      ...
      <View style={[, { display: 'flex', justifyContent: 'space-around', width:400,flexDirection: 'row', borderRadius: 10,  borderRadius: 10,borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5, padding: 2 }]}>
        <View style={[, { justifyContent: 'center', alignItems: 'center' }]}>
          <Text style={[, { color: 'white', fontSize: 16, margin: 10,color:'lightgrey' }]}>{t("Energy")}</Text>
          <Text style={[, { color: 'white', fontSize: 25,marginBottom:7}]}>{energyx} kcal</Text>
...
/>
      ...
      <View style={[, { display: 'flex', flexDirection: 'row', justifyContent: 'space-around' }]}>
        <TouchableOpacity onPress={() => navigation.navigate(t('Search'))} style={[, { display: 'flex',flexDirection:'row',justifyContent:'center', height: 72, width: 190, alignItems: 'center', borderRadius: 10,  borderRadius: 10,borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="cancel" color={"red"} size={50} />
          <Text style={{color:'white',marginLeft:5}}>{t("Cancel")}</Text>

        </TouchableOpacity>

        <TouchableOpacity onPress={onAdd} style={[, { display: 'flex',flexDirection:'row',justifyContent:'center', height: 72, width: 190, alignItems: 'center', borderRadius: 10,  borderRadius: 10,borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="check" color={"green"} size={50} />
          <Text style={{color:'white',marginLeft:5}}>{t("Add food")}</Text>
...
function SearchScreen({ navigation, route }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <StatusBar barStyle="dark-content" backgroundColor="#fdca40" />
      <View style={{display:'flex',flexDirection:'row'}}>
      <TextInput textAlign={'center'} autoFocus={true} onChange={handleText} placeholderTextColor={'lightgrey'} placeholder={t('Type name of food..')} style={{ width: 300,borderRadius:20, marginTop:20,marginBottom: 15, color: 'black', fontSize: 16, backgroundColor: 'white', borderTopWidth: 0.5, borderBottomWidth: 0.2 }}>{route.params != undefined ? route.params.barcode : null}</TextInput>
      <TouchableOpacity onPress={onSubmit} style={{ display: 'flex', height: 49, width: 100,marginLeft:10,marginTop:20,borderRadius:20, justifyContent: 'center', alignItems: 'center',  borderWidth:0.5,borderColor:'white', backgroundColor: 'green', }}><Text style={{color:'white'}}>{t("Submit")}</Text></TouchableOpacity>
      </View>
          ...
          <FlatList
            ...
            renderItem={({ item }) => {
              const onFoodItemPress = e => {
                navigation.navigate(t('Details food'), {
                  food: item,
                });
              };
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          ...
          const onFoodItemPress = e => {
            ...
            navigation.navigate(t('Update food'), {
              name: item.name,
              ...
              navigation.navigate(t('Update activity'),{
...
function UpdateActivityScreen({ navigation, route }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={[, { display: 'flex', borderRadius: 10,width:400, borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5, padding: 2 }]}>
        <Text style={[, { color: 'white', margin: 10, fontSize: 16 }]}>{t("Calorie (Energy in kcal):")}</Text>
        <View style={[, { margin: 5, display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly', alignItems: 'center' }]}>
          <TextInput  onChangeText={text => setText(text)} keyboardType='numeric'  placeholderTextColor={'lightgrey'} placeholder={t('Calories')} style={{paddingLeft:20, width: 380,borderRadius:10,marginTop:10, marginBottom: 15, color: 'black', fontSize: 16, backgroundColor: 'white', borderTopWidth: 0.5, borderBottomWidth: 0.2 }}>{energy}</TextInput>

         </View>
         </View>
      <View style={[, { display: 'flex', flexDirection: 'row', justifyContent: 'space-around' }]}>
        <TouchableOpacity onPress={onRemove} style={[, { display: 'flex',  flexDirection:'row',justifyContent:'center',height: 72, width: 190, alignItems: 'center', borderRadius: 10, borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="trash-can-outline" color={"red"} size={50} />
          <Text style={{color:'white',marginLeft:5}}>{t("Remove activity")}</Text>

        </TouchableOpacity>

        <TouchableOpacity onPress={onUpdate} style={[, { display: 'flex',  flexDirection:'row',justifyContent:'center',height: 72, width: 190, alignItems: 'center', borderRadius: 10,borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="check" color={"green"} size={50} />
          <Text style={{color:'white',marginLeft:5}}>{t("Update")}</Text>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={[, { display: 'flex', borderRadius: 10,width:400, borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5, padding: 2 }]}>
        <Text style={[, { color: 'white', margin: 10, fontSize: 16 }]}>{t("Quantity")}</Text>
        <View style={[, { margin: 5, display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly', alignItems: 'center' }]}>
          <TextInput placeholderTextColor={'black'} keyboardType='numeric' textAlign={'center'} autoFocus={true} style={[, { backgroundColor: 'black',borderColor:'white', borderBottomWidth: 1, color: 'white', height: 40, width: 70 }]} onChangeText={text => setText(text)}>{quantita}</TextInput>
          <Text style={[, { fontSize: 15 }]}>X</Text>
          <Picker style={[, { backgroundColor: 'black', height: 40, width: 230 }]}
            selectedValue={selectedweight}
            onValueChange={(itemValue, itemIndex) =>
...
/>
      ...
      <View style={[, { display: 'flex', flexDirection: 'row', justifyContent: 'space-around' }]}>
        <TouchableOpacity onPress={onRemove} style={[, { display: 'flex', flexDirection:'row',justifyContent:'center', height: 65, width: 190, alignItems: 'center', borderRadius: 10, borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="trash-can-outline" color={"red"} size={50} />
            <Text style={{color:'white',marginLeft:5}}>{t("Remove food")}</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={onUpdate} style={[, { display: 'flex',flexDirection:'row',justifyContent:'center', height: 65, width: 190, alignItems: 'center', borderRadius: 10, borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="check" color={"green"} size={50} />
          <Text style={{color:'white',marginLeft:5}}>{t("Update")}</Text>
        </TouchableOpacity>
      </View>
...
if(totalFatPercent>80){
  ...
  const EnergyData = [
    ...
    {value: goalEnergy-totalEnergy+totalActivity, color: colorEnergyZvysok
}
];
const ProteinData = [
...
let youNedd=goalEnergy-totalEnergy+totalActivity
  if(totalEnergy-totalActivity>=goalEnergy){
youNedd=0}
  const onChange = (event, selectedDate) => {
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <TextInput onChangeText={text => setWeight(text)} autoFocus={true}  placeholderTextColor={'lightgrey'} placeholder={t("Weight")+' (Kg)'} style={{paddingLeft:20, width: 200,borderRadius:10,marginTop:10, marginBottom: 15, color: 'black', fontSize: 16, backgroundColor: 'white', borderTopWidth: 0.5, borderBottomWidth: 0.2 }}/>
            <View style={{display:'flex',flexDirection:'row'}}>
            <TouchableOpacity onPress={() => setModalVisible(!modalVisible)} style={[, { display: 'flex',flexDirection:'row',justifyContent:'center', height: 65, width: 120, alignItems: 'center',borderWidth:0.5, borderRadius: 10, borderColor:'white',backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="cancel" color={"red"} size={40} />
          <Text style={{color:'white',marginLeft:5}}>{t("Cancel")}</Text>

        </TouchableOpacity>

        <TouchableOpacity onPress={onPress1} style={[, { display: 'flex',flexDirection:'row',justifyContent:'center', height: 65, width: 120, alignItems: 'center', borderRadius: 10, borderWidth:0.5,backgroundColor: 'black',borderColor:'white', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="check" color={"white"} size={40} />
          <Text style={{color:'white',marginLeft:5}}>{t("Add")}</Text>
 ...
 {day}, {diaryKeyDate.toString().substr(8, 2)}. {(diaryKeyDate.getMonth())+1}.</Text>
      ...
      <View style={{display: 'flex',marginTop:0,height:90,width:420,justifyContent:'space-evenly',flexDirection:'row'}}>
        <TouchableOpacity onPress={()=>navigation.navigate(t('Foods'))}>
       ...
       <View style={{display:'flex',flexDirection:'row',justifyContent:'space-between'}}><Text style={{paddingLeft:5,fontSize:29,  color:'white'}}>{totalEnergy-totalActivity} kcal</Text><MaterialCommunityIcons style={{}} name="plus-circle" color={"green"} size={20} />
</View>
        </View>
        </TouchableOpacity>

        <TouchableOpacity onPress={()=>navigation.navigate(t('Search'))}>
        <View style={{backgroundColor:'black',borderColor:'white',borderWidth:0.5, height:90,width:190,margin:5,borderRadius:20, padding:10,display:'flex',justifyContent:'space-between'}}>
       <Text style={{color:'grey',paddingLeft:5,fontSize:15}}>{t("You need")}</Text>
       <View style={{display:'flex',flexDirection:'row',justifyContent:'space-between'}}><Text style={{paddingLeft:5,fontSize:29,  color:colorTextEnergy}}>{youNedd} kcal</Text><MaterialCommunityIcons style={{}} name="plus-circle" color={"green"} size={20} />
</View>
        </View>
        </TouchableOpacity>
      </View>
...
function MyTabs() {
  ...
  return (
    <Tab.Navigator  screenOptions={options = {tabBarItemStyle:{backgroundColor:'#fdca40',borderColor:'black'}, tabBarActiveBackgroundColor:'#fdca40',tabBarLabelStyle: {color:'black',  fontSize: 13,marginTop:-5,marginBottom:5 }, tabBarStyle: { height: 65,borderColor:'black',borderTopWidth: 0, borderTopColor: "transparent", }, tabBarShowLabel: true, tabBarLabelPosition: "below-icon" }}>
      <Tab.Screen options={{
        headerShown: false,
        tabBarIcon: () => (
          <MaterialCommunityIcons name="fire" color={"black"} size={37} />
        ),
      }} name={t("Overview")} component={OverviewTabScreen} />
      <Tab.Screen options={{
        headerShown: false, tabBarIcon: () => (
          <MaterialCommunityIcons name="food" color={"black"} size={37} />
        ),
...
goalCatrbohydrates = 500
  ...
  goalCatrbohydrates = diaryyy.goalCarbohydrates
    ...
    return(
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView2}>
            <Text style={{color:'lightgrey',fontSize:30, marginBottom:20}}>{t("Goal")}</Text>
            <Picker style={[, {textAlign:'center', backgroundColor: 'black', height: 20, width: 250, marginBottom:20 }]}
          selectedValue={selectedGoal}
          onValueChange={(itemValue, itemIndex) =>
            setSelectedGoal(itemValue)
          }>
          <Picker.Item label={t("Gain muscle")} value={2500} />
          <Picker.Item label={t("Be fit")} value={2000} />
          <Picker.Item label={t('Lose weight')} value={1500} />

        </Picker>
        <View style={{display:'flex',flexDirection:'row',justifyContent:'center',alignItems:'center', marginBottom:20}}>
          <Text style={{color:'white',fontSize:15,marginRight:20,marginBottom:10}}>{t("Energy")}</Text>
            <TextInput onChangeText={text => setSelectedGoal(text)}  placeholderTextColor={'lightgrey'} placeholder={t("Energy")+' (Kcal)'} style={{paddingLeft:20, width: 200,borderRadius:10,marginTop:10, marginBottom: 15, color: 'black', fontSize: 16, backgroundColor: 'white', borderTopWidth: 0.5, borderBottomWidth: 0.2 }}>{selectedGoal}</TextInput>
            </View>
            <View style={{display:'flex',flexDirection:'row'}}>
            <TouchableOpacity onPress={onPress3} style={[, { display: 'flex',  flexDirection:'row',justifyContent:'center',height: 75, width: 150, alignItems: 'center', borderRadius: 10, borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="cancel" color={"red"} size={40} />
          <Text style={{color:'white',marginLeft:5}}>{t("Cancel")}</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={onPress1} style={[, { display: 'flex',  flexDirection:'row',justifyContent:'center',height: 75, width: 150, alignItems: 'center', borderRadius: 10, borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="check" color={"white"} size={40} />
          <Text style={{color:'white',marginLeft:5}}>{t("Set goal")}</Text>
        </TouchableOpacity>
            </View>
          </View>
        </View>
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView3}>
            <Text style={{color:'lightgrey',fontSize:30, marginBottom:20,textAlign:'center'}}>{t("Nutriments")}</Text>
        ...
        <View style={{display:'flex',flexDirection:'row',justifyContent:'flex-end',alignItems:'center', marginBottom:20}}>
          ...
          <Text style={{color:'white',fontSize:15,marginRight:20,marginBottom:10}}>{t("Protein")}</Text>
            </View>
            <TextInput editable={isSelected} onChangeText={text => setSelectedProtein(text)}  placeholderTextColor={'lightgrey'} placeholder={t("Protein")+' (g)'} style={{paddingLeft:20, width: 200,borderRadius:10,marginTop:10, marginBottom: 15, color: 'black', fontSize: 16, backgroundColor: 'white', borderTopWidth: 0.5, borderBottomWidth: 0.2 }}>{goalProtein}</TextInput>
            </View>
            <View style={{display:'flex',flexDirection:'row',justifyContent:'flex-end',alignItems:'center', marginBottom:20}}>
            <View style={{display:'flex',width:130}}>
          <Text style={{color:'white',fontSize:15,marginRight:20,marginBottom:10}}>{t("Fat")}</Text>
          </View>
            <TextInput editable={isSelected} onChangeText={text => setSelectedFat(text)}  placeholderTextColor={'lightgrey'} placeholder={t("Fat")+' (g)'} style={{paddingLeft:20, width: 200,borderRadius:10,marginTop:10, marginBottom: 15, color: 'black', fontSize: 16, backgroundColor: 'white', borderTopWidth: 0.5, borderBottomWidth: 0.2 }}>{goalFat}</TextInput>
            </View>
            <View style={{display:'flex',flexDirection:'row',justifyContent:'flex-end',alignItems:'center', marginBottom:20}}>
            <View style={{display:'flex',width:130}}>
          <Text style={{color:'white',fontSize:15,marginRight:20,marginBottom:10}}>{t("Carbohydrates")}</Text>
          </View>
            <TextInput editable={isSelected} onChangeText={text => setSelectedCarbohydrates(text)}  placeholderTextColor={'lightgrey'} placeholder={t("Carbohydrates")+' (g)'} style={{paddingLeft:20, width: 200,borderRadius:10,marginTop:10, marginBottom: 15, color: 'black', fontSize: 16, backgroundColor: 'white', borderTopWidth: 0.5, borderBottomWidth: 0.2 }}>{goalCatrbohydrates}</TextInput>
            </View>
            <View style={{display:'flex',flexDirection:'row',justifyContent:'flex-end',alignItems:'center', marginBottom:20}}>
            <View style={{display:'flex',width:130}}>
          <Text style={{color:'white',fontSize:15,marginRight:20,marginBottom:10}}>{t("Fiber")}</Text>
          </View>
            <TextInput editable={isSelected} onChangeText={text => setSelectedFiber(text)}  placeholderTextColor={'lightgrey'} placeholder={t("Fiber")+' (g)'} style={{paddingLeft:20, width: 200,borderRadius:10,marginTop:10, marginBottom: 15, color: 'black', fontSize: 16, backgroundColor: 'white', borderTopWidth: 0.5, borderBottomWidth: 0.2 }}>{goalFiber}</TextInput>
            </View>
            <View style={{display:'flex',flexDirection:'row',justifyContent:'center'}}>
            <TouchableOpacity onPress={() => setModal2Visible(!modal2Visible)} style={[, { display: 'flex', flexDirection:'row',justifyContent:'center', height: 75, width: 160, alignItems: 'center', borderRadius: 10, borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="cancel" color={"red"} size={40} />
          <Text style={{color:'white',marginLeft:5}}>{t("Cancel")}</Text>

        </TouchableOpacity>

        <TouchableOpacity onPress={onPress2} style={[, { display: 'flex',  flexDirection:'row',justifyContent:'center',height: 75, width: 160, alignItems: 'center', borderRadius: 10, borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="check" color={"white"} size={40} />
          <Text style={{color:'white',marginLeft:5}}>{t("Set nutriments")}</Text>
      ...
      <Text style={{fontSize:20, color:'lightgrey'}}>{t("Goals")}</Text>
    </TouchableOpacity>
    <TouchableOpacity onPress={() => setModal2Visible(true)} style={{display:'flex',marginTop:1,paddingLeft:20,justifyContent:'center',backgroundColor:'black',width:420,height:60,borderBottomWidth:0.5,borderColor:'white' }}  >
      <Text style={{fontSize:20, color:'lightgrey'}}>{t("Nutriments")}</Text>
    </TouchableOpacity>
      </View>
    )
  }
  ...
  return(
    <View style={styles.container}>
      ...
      <View style={[, { display: 'flex', flexDirection: 'row', justifyContent: 'space-around',marginTop:20 }]}>
        <TouchableOpacity onPress={() => navigation.navigate(t('Overview'))} style={[, { display: 'flex', flexDirection:'row',justifyContent:'center',height: 72, width: 180, alignItems: 'center', borderRadius: 10, borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="cancel" color={"red"} size={50} />
          <Text style={{color:'white',marginLeft:5}}>{t("Cancel")}</Text>

        </TouchableOpacity>

        <TouchableOpacity onPress={onAdd} style={[, { display: 'flex',flexDirection:'row',justifyContent:'center', height: 72, width: 180, alignItems: 'center', borderRadius: 10, borderWidth:0.5,borderColor:'white', backgroundColor: 'black', marginVertical: 10, marginHorizontal: 5 }]} >
          <MaterialCommunityIcons name="check" color={"green"} size={50} />
          <Text style={{color:'white',marginLeft:5}}>{t("Add Activity")}</Text>
 ...
 requestCameraPermission()
  ...
  return (
    <View style={{
      ...
      <Button title={t("reload")} onPress={reload} />
    </View>
      ...
      <SafeAreaProvider>
        ...
        <NavigationContainer>
          <Drawer.Navigator drawerContent={props => <DrawerContent {...props} />}>
            ...
            <Drawer.Screen options={{ headerStyle: { backgroundColor: '#fdca40', }, headerTintColor: 'black', }} name={t("Search")} component={SearchScreen} />
