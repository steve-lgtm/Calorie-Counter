...
function MyTabs() {
  ...
  return (
    <Tab.Navigator tabBarOptions={{showLabel:false,}} screenOptions={  options={tabBarLabelStyle: {fontS},tabBarStyle: {height: 60},tabBarShowLabel:true,tabBarLabelPosition:"below-icon"}}>
