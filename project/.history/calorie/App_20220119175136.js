...
function MyTabs() {
  ...
  return (
    <Tab.Navigator screenOptions={options = {tabBarItemStyle:{backgroundColor:'black'}, tabBarActiveBackgroundColor:'#fdca40',tabBarLabelStyle: {color:'white',  fontSize: 13 }, tabBarStyle: { height: 60,.borderColor:'white' }, tabBarShowLabel: true, tabBarLabelPosition: "below-icon" }}>
      <Tab.Screen options={{
        headerShown: false,
        tabBarIcon: () => (
