...
function OverviewTabScreen({ navigation }) {
  ...
  const goalProtein = 413
  const goalFat = 187
  const goalFiber = 27.5
  const goalCatrbohydrates = 809
  ...
  let colorEnergy='lightgray'
  let colorProtein ='lightgray'
  let colorCarbohydrates='lightgray'
  let colorFat='lightgray'
  let colorFiber = 'lightgray'
 ...
 if(totalFat>goalFat)
 colorFat = '#177AD5'
 if(totalCarbohydrates>goalCatrbohydrates)
 colorCarbohydrates = '#177AD5'
 if(totalFiber>goalFiber)
 colorFiber = '#177AD5'
  ...
  const EnergyData = [
    {value: totalEnergy, color: '#177AD5'},
    {value: goalEnergy-totalEnergy, color: colorEnergy}
];
const ProteinData = [
  {value: totalProtein, color: '#177AD5'},
  {value: goalProtein-totalProtein, color: colorProtein}
];
const FatData = [
  {value: totalFat, color: '#177AD5'},
  {value: goalFat-totalFat, color: colorProtein}
];
const CarbohydratesData = [
  {value: totalCarbohydrates, color: '#177AD5'},
  {value: goalCatrbohydrates-totalCarbohydrates, color: colorProtein}
];
const FiberData = [
  {value: totalFiber, color: '#177AD5'},
  {value: goalFiber-totalFiber, color: colorProtein}
];
  const onChange = (event, selectedDate) => {
    setShow(false);
    const currentDate = selectedDate || date;
 ...
 {day}, {diaryKeyDate.toString().substr(8, 2)}. {(diaryKeyDate.getMonth())+1}.</Text>
      ...
      <View style={{display:'flex', flexDirection:'row', justifyContent:'center',width:420,height:200,marginTop:15}}>
       ...
       backgroundColor={'black'}
                ...
                return <Text style={{fontSize: 25, color:'black'}}>{(100*(totalEnergy/goalEnergy)).toFixed()} %</Text>;
                }}
            />
             </View>
    ...
    <View style={{display:'flex', flexDirection:'row', marginTop:-25,}}>
      <View style={{marginLeft:-35}}>
       ...
       style={{}}
                ...
                data={ProteinData}
                centerLabelComponent={() => {
                return <Text style={{fontSize: 10, color:'black'}}>{(100*(totalProtein/goalProtein)).toFixed()} %</Text>;
                }}
            />
            </View>
             <View style={{display:'flex',justifyContent:'center', alignItems:'flex-start',marginLeft:-15, width:80, backgroundColor:'red'}}>
       ...
       style={{}}
                ...
                data={FatData}
                centerLabelComponent={() => {
                return <Text style={{fontSize: 10, color:'black'}}>{(100*(totalFat/goalFat)).toFixed()} %</Text>;
                }}
            />
             <View style={{display:'flex',justifyContent:'center', alignItems:'flex-start',marginLeft:-15}}>
            <Text style={{color:'lightgray',fontSize:10}}>Fat</Text>
              <Text style={{color:'white',fontSize:18}}>{totalFat} kcal</Text>
              <Text style={{color:'lightgray',fontSize:13}}>of {goalFat} kcal</Text>
    ...
    <View style={{display:'flex', flexDirection:'row', marginTop:-25}}>
      <View style={{marginLeft:-35}}>
       ...
       style={{}}
                ...
                centerLabelComponent={() => {
                return <Text style={{fontSize: 10, color:'black'}}>{(100*(totalCarbohydrates/goalCatrbohydrates)).toFixed()} %</Text>;
                }}
            />
            </View>
             <View style={{display:'flex',justifyContent:'center', alignItems:'flex-start',marginLeft:-15}}>
            <Text style={{color:'lightgray',fontSize:10}}>Carbohydrates</Text>
              <Text style={{color:'white',fontSize:18}}>{totalCarbohydrates} kcal</Text>
              <Text style={{color:'lightgray',fontSize:13}}>of {goalCatrbohydrates} kcal</Text>
       ...
       style={{}}
                ...
                data={FiberData}
                centerLabelComponent={() => {
                return <Text style={{fontSize: 10, color:'black'}}>{(100*(totalFiber/goalFiber)).toFixed()} %</Text>;
                }}
            />
             <View style={{display:'flex',justifyContent:'center', alignItems:'flex-start',marginLeft:-15}}>
            <Text style={{color:'lightgray',fontSize:10}}>Fiber</Text>
              <Text style={{color:'white',fontSize:18}}>{totalFiber} kcal</Text>
              <Text style={{color:'lightgray',fontSize:13}}>of {goalFiber} kcal</Text>
