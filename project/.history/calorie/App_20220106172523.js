...
function OverviewTabScreen({ navigation }) {
 ...
 {day}, {diaryKeyDate.toString().substr(8, 2)}. {(diaryKeyDate.getMonth())+1}.</Text>
      ...
      <TouchableOpacity onPress={()=>navigation.navigate('Search')}>
       ...
       <Text style={{paddingLeft:5,fontSize:30, display:'flex',flexDirection:'column', color:'white',justifyContent:'space-around'}}>{total} kg <MaterialCommunityIcons style={{}} name="plus-thick" color={"white"} size={15} />
</Text>
        </View>
        </TouchableOpacity>
