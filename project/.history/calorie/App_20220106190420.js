...
function OverviewTabScreen({ navigation }) {
 ...
 {day}, {diaryKeyDate.toString().substr(8, 2)}. {(diaryKeyDate.getMonth())+1}.</Text>
      ...
      <View style={{display:'flex', flexDirection:'row', justifyContent:'center',width:420,height:200,backgroundColor:'red'}}>
       <View style={{display:'flex',justifyContent:'flex-start',marginLeft:-170,marginRight:50}}>
       <PieChart
       style={{}}
       backgroundColor={'black'}
            ...
            <View style={{display:'flex',justifyContent:'center', alignItems:'center',backgroundColor:'yellow',width:200}}>
              <Text>Total</Text>
            </View>
